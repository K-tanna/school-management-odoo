...
class SchoolFeesPayment(models.Model):
    ...
    #Check whether  Payment is Greater than 0 or not
    @api.constrains('amount')
    ...
    # this will add Receipt Number using Sequence in Db
    @api.model
    def create(self,vals_list):
        for vals in vals_list:
            if vals.get('name','New')=="New":
                vals['name']=self.env['ir.sequence'].next_by_code('school.fees.payment')
